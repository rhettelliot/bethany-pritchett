...
export default function NotFound() {
  return (
    ...
    >
      ...
      <h1 className="font-display text-4xl md:text-6xl mt-6 mb-4" style={{ color: 'var(--text-primary)' }}>
        Page not found
      </h1>
      <p className="font-body text-sm mb-12" style={{ color: 'var(--text-secondary)' }}>
