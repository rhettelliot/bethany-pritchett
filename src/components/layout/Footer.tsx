        ...
        <div className="mt-10 pt-8 flex flex-col md:flex-row justify-between items-start md:items-end gap-8" style={{ borderTop: '1px solid rgba(196,120,138,0.06)' }}>
          ...
          <div className="flex flex-col items-start md:items-end gap-2">
            ...
            <div className="flex flex-col md:items-end gap-1">
              <a href="https://redshiftmantra.vercel.app" target="_blank" rel="noreferrer noopener" aria-label="Visit Red Shift Mantra artist site (opens in new tab)" className="font-mono text-[10px] tracking-[0.1em] transition-colors duration-300" style={{ color: '#B88A9A' }} onMouseEnter={(e) => { e.currentTarget.style.color = '#C4788A' }} onMouseLeave={(e) => { e.currentTarget.style.color = '#B88A9A' }}>Red Shift Mantra ↗</a>
